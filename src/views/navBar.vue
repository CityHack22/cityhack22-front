  ...
  <div class="navigation" v-if="!isPersonalPage">
    <v-container class="pb-0">
      <v-row class="iconLink mt-md-3 mb-md-3 mx-0 mb-1 mt-1">
        <v-col class="d-flex p-0">
          <a href="https://www.instagram.com/cityhack22/" target="_blank"><v-icon class="mr-2">mdi-instagram</v-icon></a>
          <a href="https://discord.gg/cEYctkjTeE" target="_blank"><v-icon class="mr-2">mdi-discord</v-icon></a>
          <v-spacer></v-spacer>
          <a
          ...
          <a>
            <v-chip pill dark class="v-chip--clickable">CS Student Chapter</v-chip>
          </a>
    ...
    <div class="d-flex justify-center align-center">
      ...
      <router-link class="pl-3 d-none d-md-block" to="/" style="font-size: 40px; font-weight: bold;">#CityHack 20<span
          style="color:#ff9900;">22</span></router-link>
    ...
    <v-app-bar class="appBar" elevation="0" flat justify="center" no-gutters dense>
      ...
      <v-app-bar-nav-icon
          ...
          width
      ></v-app-bar-nav-icon>
      <v-btn text><a href='https://cityu.zoom.us/j/99883967052?pwd=bXBadGkxbms4alNrQ3Q0RTYvYVFRdz09' target='_blank'>Join Zoom</a></v-btn>
