      ...
      items: [
        {
          ...
          items: [
            ...
            {title: 'Please create a team with more than 2 members or join any public group by the end of 26th Jan. We are not responsible for finding a team for any participant. Please team-up with the tool on your personal panel on cityhack21.com'},
            {title: 'Every team needs to prepare their own equipment such as laptops, mobile phones, and chargers.'},
          ],
        ...
        },
        {
          ...
          items: [
            {title: 'Participants should only start working on the project on 29th Jan.'},
        ...
        },
        {
          ...
          items: [
            {title: 'There must be at least one CityU student on the team. Only team with at least one CityU student are eligible to receive HK tech 300 Seed fund'},
            ],
          title: 'HK tech 300 Seed fund Rules',
        },
        {
