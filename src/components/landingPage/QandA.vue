			...
			return {
				qas: [
					...
					},
					{
						...
						question: 'Do I have to form a group?',
						answer:
							'Yes, Participants should form a group with 3 to 5 people. \
                    Please find your teammates before Jan 26th.',
					},
					{
						img:
						...
						answer:
							"Considering the pandemic case, CityHack2022 will be held completely online. \
					...
					},
					{
						...
						answer:
							...
							in using the recommended software tools, e.g. Huawei Cloud. There will be mentors on the spot\
